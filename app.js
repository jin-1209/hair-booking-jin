...
const TRANSLATIONS = {
  ...
  en: {
    ...
    hero_desc: 'Honed over two decades in Harajuku, Omotesando, and Aoyama — Tokyo\'s most iconic hair districts. Bringing world-class, one-on-one styling to Singapore.',
    hero_cta: 'Book Now',
    hero_menu: 'View Menu',
    trust_exp: 'Years Exp.',
  ...
  zh: {
    ...
    hero_title_2: '现于新加坡。',
    hero_desc: '在原宿、表参道、青山——东京最具代表性的美发圣地磨练20年的技术与审美，现为您提供一对一的专属造型服务。',
    hero_cta: '立即预约',
    hero_menu: '查看菜单',
    trust_exp: '年经验',
    trust_clients: '服务客户',
